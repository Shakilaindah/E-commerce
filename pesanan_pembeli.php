...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg  bg-dark">
      <div class="container">
        <a class="navbar-brand text-white" href="user.php"><strong>Bakso Sedarhana</strong></a>
    ...
    <div class="row footer-body">
      ...
      <div class="col-md-6 d-flex justify-content-end">
        <div class="icon-contact">
          ...
          <a href="https://instagram.com/tiaraoktaviaa28?igshid=YmMyMTA2M2Y="><img src="images/icon/ig.png" class="mr-3" data-toggle="tooltip" title="Instagram"></a>
